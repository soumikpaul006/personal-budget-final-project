 ...
 * //=> 'in 2 yr'
 */
export declare function intlFormatDistance<DateType extends Date>(date: DateType | number | string, baseDate: DateType | number | string, options?: IntlFormatDistanceOptions): string;
