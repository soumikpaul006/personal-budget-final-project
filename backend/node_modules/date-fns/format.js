...
var _index5 = require("./_lib/format/formatters.js");
var _index6 = require("./_lib/format/longFormatters.js");
var _index7 = require("./_lib/protectedTokens.js");
...
function format(date, formatStr, options) {
  ...
  const result = formatStr.match(longFormattingTokensRegExp).map(function (substring) {
    ...
    if (formatter) {
      if (!options?.useAdditionalWeekYearTokens && (0, _index7.isProtectedWeekYearToken)(substring)) {
        (0, _index7.throwProtectedError)(substring, formatStr, String(date));
      }
      if (!options?.useAdditionalDayOfYearTokens && (0, _index7.isProtectedDayOfYearToken)(substring)) {
        (0, _index7.throwProtectedError)(substring, formatStr, String(date));
      }
