...
export declare class ValueSetter<Value> extends Setter {
    ...
    private setValue;
    priority: number;
    constructor(value: Value, validateValue: <DateType extends Date>(utcDate: DateType, value: Value, options: ParserOptions) => boolean, setValue: <DateType extends Date>(utcDate: DateType, flags: ParseFlags, value: Value, options: ParserOptions) => DateType | [DateType, ParseFlags], priority: number, subPriority?: number);
