...
import { isProtectedDayOfYearToken, isProtectedWeekYearToken, throwProtectedError } from "./_lib/protectedTokens.mjs"; // This RegExp consists of three parts separated by `|`:
